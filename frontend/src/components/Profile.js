...
function Profile() {
    ...
    return (
        <div className="w-full mt-4">
            ...
            <div className="flex flex-col relative py-16 bg-blue-200 h-full">
                            ...
                            <div className="flex flex-wrap justify-center">
                                <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                                    <div className="relative w-36 h-36 xl:w-40 xl:h-40 flex-grow-0 flex-shrink-0 -mt-20">
                                        <img src="https://www.nitj.ac.in/images/faculty/20071962443.jpg" className="w-full h-full object-cover object-left-top rounded-full shadow-xl flex-grow-0 flex-shrink-0" alt='...' />
                                    </div>
                                </div>
                                            ...
                                            <div className='cards scrollhide flex items-center snap-x h-14 border-t border-b border-blue-200 m-2 overflow-x-auto overflow-y-hidden'>
                                                {
                                                    Link.map((item, i) => {
                                                        return (
                                                            <div key={i} className={"border border-blue-400 snap-center shrink-0 w-max rounded-full px-3 py-1.5 m-1 cursor-pointer hover:bg-blue-200 active:scale-95 duration-150 "+(active===i?'bg-blue-200':'')} onClick={()=>setActive(i)}>{item.Title}</div>
                                                        )
                                                    })
                                                }
                                            </div>
