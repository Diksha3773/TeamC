...
function Menu({ fixedmenu }) {
    ...
    return (
        <>
            <div className={"flex flex-col bg-white z-50 lg:z-10 items-center ml-2 max-h-[78vh] lg:h-[78vh] max-w-full overflow-hidden text-gray-700 rounded lg:" + (fixedmenu ? 'absolute bottom-1' : scroll?'fixed top-[90px]':'fixed')}>
