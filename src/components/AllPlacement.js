...
function AllPlacement() {
    ...
    return (
        <>
            <div className='w-full rounded-[9px] border border-[rgba(0,105,140,0.1] p-4 mx-1 xl:mx-3 my-[90px] pt-[54px] place-items-center'>
                ...
                <div className='flex items-center justify-center w-full my-3 mx-auto mb-16'>
                    <input placeholder='Search by (Company Name, Name, Packages)' defaultValue={""} onChange={(e) => {  }} className='w-11/12 md:w-3/4 p-2 text-lg rounded border-2 shadow-lg border-gray-300 focus:border-gray-400 focus:outline-none' />
                </div>
