                                    ...
                                    <div key={i} ref={myref} className='w-[85%] sm:w-full m-2  h-[21rem] flex items-center justify-center group'>
                                            <div className='card border border-white rounded-lg'>
                                                ...
                                                <div className="flex flex-col items-center pb-10">
                                                    ...
                                                    <h4 className="text-lg text-gray-300 dark:text-gray-400 group-hover:text-xl">{item.packages} L.P.A</h4>
                                                    <h4 className="text-lg text-gray-300 dark:text-gray-400 group-hover:text-xl">({item.duration})</h4>
                                                </div>
                                            </div>
                                        </div>
                                ) : <></>) :
