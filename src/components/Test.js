...
function Test() {
    ...
    return (
        <>
            <div className="mt-0 md:mt-6 relative">
                <div className="relative w-full overflow-hidden">
                    <div className='relative bg-gradient-to-b from-accent to-transparent bg-cover bg-center w-full items-center transition-all justify-center'>
                        ...
                        <div className='absolute bg-gradient-to-b from-accent to-transparent bg-cover bg-center text-blue-50 flex flex-col w-full h-full top-0 items-center justify-center'>
                            <h2 className="text-2xl sm:text-5xl m-2">
                                <span className="font-bold">NITJ</span> Welcomes you
                            </h2>
                            <div className="sm:text-3xl m-2">
                                <h6>Computer Science and Engineering</h6>
                            </div>
                        </div>
                        <div className='top-0 absolute w-full h-full flex items-center justify-between text-white p-2'>
