...
function Navbar() {
    ...
    return (
        <>
            <div className='flex flex-col h-auto w-full md:h-screen'>
                ...
                <button className='p-2 bg-zinc-900 flex items-center md:hidden'onClick={()=>{setOpen(!open)}} >
                    <img src={Hambur} alt="..." className='h-8 w-8 m-1 p-1 rounded-lg hover:border' />
                </button>
                <div className='md:flex w-full justify-center md:p-2 md:items-center md:flex-row' style={open?{dispay:"flex",flexDirection:'column'}:{display:"none"}}>
                    <div className='group bg-gray-400 shadow-sm p-2 m-0 md:border-none'><a href='/' className='my-2 mx-4 font-medium hover:text-blue-600'>Home</a></div>
                    <div className='group bg-gray-400 shadow-sm p-2 m-0 md:border-none'>
