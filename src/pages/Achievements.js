...
function Achievements() {
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <h1 className="mt-10 text-4xl font-bold   text-orange-600">Achievements</h1>

      <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-2 mx-auto" >
        {
          Achievement.map((item,i) => {
            return (
              <div key={i} className="relative min-w-0 max-w-md break-words bg-white m-2 mb-6 shadow-md mt-5 rounded-xl  border-2 border-blue-200 hover:shadow-2xl">
                <div className="flex flex-col break-words bg-white rounded-xl bg-clip-border transition-all flex-auto">
                  <div className="transition-all mx-2 mt-2 border-2 border-gray-300 rounded-lg shadow-2xl overflow-hidden shadow-gray-400">
                    <img
